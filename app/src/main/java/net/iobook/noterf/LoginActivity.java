...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String SERVER_URL = "https://ioPush.net/app/";
    private static final String IOPUSH_URL_GET_AUTH_TOKEN = "api/getAuthToken";
    /**
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            if (checkPlayServices()) {
                try {
                    ...
                    HttpResultHelper httpResult = http.post(SERVER_URL + IOPUSH_URL_GET_AUTH_TOKEN, null, null);
                    ...
                    if (httpResult.getStatusCode() == 200) {
                        ...
                        SharedPreferences userSharedPref = getApplicationContext().getSharedPreferences(
                                getString(R.string.preferenceUser), Context.MODE_PRIVATE);
                        userSharedPref.edit().putString(getString(R.string.preferenceUserNickname), nickname).apply();
                        userSharedPref.edit().putString(getString(R.string.preferenceUserAuthToken), authToken).apply();
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                Intent intent = new Intent(QuickstartPreferences.AUTHENTICATION_COMPLETE);
